...
const ShareProject = ({ isOpen, toggle }) => {
    ...
    return (
        <Modal isOpen={isOpen} toggle={toggle} className="modal-abs">
            ...
            <ModalBody>
                ...
                />
                <h5 className='text-white mt-3'>People with access</h5>
                ...
                <div className="d-flex justify-content-between mt-3">
                    <div className="d-flex align-items-center folder mr-2 py-1 px-1">
                    ...
                    <div className="project py-1 px-3">
                        <h5 className="text-dark font-weight-bold ml-1 mb-0">Done</h5>
                    </div>
                </div>
            </ModalBody>
